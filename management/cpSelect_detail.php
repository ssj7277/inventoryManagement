		...
		<article class="select_body">
								...
								if ($dbCommRows > 0) {
									...
									while ( $dbComm = $comm_result->fetch_array() ) {
										...
										<tr>
											...
											<td><button type="button" onclick="commentDelete()"
			...
			<div class="comment_edit">
				<form method="post" name="commEditForm" id="commEditForm">
					...
					<input type="text" name="commEditUser" id="commEditUser" class="" size="15" maxlength="10"
						placeholder="작성자">
					<div class="">
						<textarea class="commContent" name="commContent" id="commContent" maxlength="100"
			...
			<form class="insert_frm" action="cpModify_result.php" method="post" id="modifyCp" name="frm">
				<div class="mb-3 mt-3">
					...
					<input type="text" class="form-control" id="cpName" name="cpName" maxlength="10" placeholder="예) 교농"
						value="<?php echo $dbCp['name']; ?>" required>

					<label for="cpPhoneNum" class="form-label">회사 전화번호:</label>
					<input type="text" class="form-control" id="cpPhoneNum" name="cpPhoneNum"
						placeholder="예) 010-1234-7890" maxlength="20" value="<?php echo $dbCp['phone']; ?>">

					<label for="cpFaxNum" class="form-label">회사 팩스번호:</label>
					<input type="text" class="form-control" id="cpFaxNum" name="cpFaxNum" placeholder="예) 033-1234-5678"
						maxlength="20" value="<?php echo $dbCp['fax'] ?>">
					...
					<input type="email" class="form-control" id="cpEmail" name="cpEmail" placeholder="example@gmail.com"
						value="<?php echo $dbCp['email'] ?>">

					<label for="cpAddress" class="form-label">회사 주소:</label>
					<input type="text" class="form-control" id="cpAddress" name="cpAddress"
						placeholder="예) 서울시 강남구 삼성동 16-1" value="<?php echo $dbCp['address'] ?>">

					<label for="cpRegiNum" class="form-label">사업자 등록번호:</label>
					<input type="text" class="form-control" id="cpRegiNum" name="cpRegiNum"
						placeholder="개인사업자는 주민번호를 입력바랍니다." maxlength="20" value="<?php echo $dbCp['regiNumber'] ?>">
					...
					<input type="text" class="form-control" id="cpManager" name="cpManager" placeholder="예) 임꺽정"
						value="<?php echo $dbCp['contactName'] ?>">
				...
				<div class="d-grid gap-2 d-md-block">
					...
					<button type="button" class="btn btn-outline-dark"
						onclick="javascript:history.back();"><b>취소</b></button>
				</div>
			</form>
			<!-- /edit -->
			<!-- 회사정보 삭제 -->
