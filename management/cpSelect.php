				...
				<div class="list-header">
					...
					<form id="searchForm" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						<fieldset class="select_filedset">
							<select title="검색항목선택" label="검색항목선택" class="form-category" name="searchType"
								id="searchType">
								<option value="name">회사명</option>
								<option value="address">회사주소</option>
							</select>
							<span class="input-group">
								<input type="text" placeholder="검색어를 입력하세요." class="form-keyword" label="검색어"
									title="검색어" name="searchText" id="searchText" />
