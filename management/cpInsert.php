...
<body>
    ...
    <section class="insert_body">
        ...
        <article>
            <form class="insert_frm" action="cpInsert_result.php" method="post" name="frm"
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="cpUpjong" name="cpUpjong"
                        placeholder="예) 작물재배업, 축산, 임업">
                </div>
